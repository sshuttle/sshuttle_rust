...
mod tests {
    ...
    fn test_setup_family_v4_tcp() {
        ...
        let expected_ipv4: [&str; 17] = [
            ...
            "iptables -w -t mangle -A sshuttle-m-tcp-1024 -j RETURN -m addrtype --dst-type LOCAL -m tcp -p tcp",
            "iptables -w -t mangle -A sshuttle-t-tcp-1024 -j RETURN -m addrtype --dst-type LOCAL -m tcp -p tcp",
    ...
    fn test_setup_family_v6_tcp() {
        ...
        let expected_ipv6: [&str; 17] = [
            ...
            "ip6tables -w -t mangle -A sshuttle-m-tcp-1024 -j RETURN -m addrtype --dst-type LOCAL -m tcp -p tcp",
            "ip6tables -w -t mangle -A sshuttle-t-tcp-1024 -j RETURN -m addrtype --dst-type LOCAL -m tcp -p tcp",
    ...
    fn test_setup_family_v4_udp() {
        ...
        let expected_ipv4: [&str; 17] = [
            ...
            "iptables -w -t mangle -A sshuttle-m-udp-1024 -j RETURN -m addrtype --dst-type LOCAL -m udp -p udp",
            "iptables -w -t mangle -A sshuttle-t-udp-1024 -j RETURN -m addrtype --dst-type LOCAL -m udp -p udp",
    ...
    fn test_setup_family_v6_udp() {
        ...
        let expected_ipv6: [&str; 17] = [
            ...
            "ip6tables -w -t mangle -A sshuttle-m-udp-1024 -j RETURN -m addrtype --dst-type LOCAL -m udp -p udp",
            "ip6tables -w -t mangle -A sshuttle-t-udp-1024 -j RETURN -m addrtype --dst-type LOCAL -m udp -p udp",
